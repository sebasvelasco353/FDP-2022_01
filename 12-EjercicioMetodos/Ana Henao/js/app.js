function verReceta(){
    ...
    var sacar = "Para sacar la torta primero asegurate de que la torta está lista, "
...
const Ingredientes = document.getElementById("Ingredientes");
    ...
    var tag = document.createElement("p")
    tag.innerHTML = Punto + harina + Punto + azucar + Punto + polvohornear  + Punto  + aceite + Punto + huevos + Punto + 'Kumis' + Punto + leche + Punto + 'Zumo de naranja y rayadura';
...
const Ingredientes = document.getElementById("Ingredientes");
     Ingredientes.innerHTML = '';
    var tag = document.createElement("p")
        tag.innerHTML = Punto + harina + Punto + 'Bananos'+ Punto + azucar + Punto + 'bicarbonato' + Punto + aceite + Punto + huevos + Punto + esenciavainilla + Punto + leche;
        ;
        Ingredientes.appendChild(tag); 
...
const Ingredientes = document.getElementById("Ingredientes");
      Ingredientes.innerHTML = '';
     var tag = document.createElement("p")
     tag.innerHTML = Punto + harina + Punto +  azucar + Punto + polvohornear + Punto + mantequilla + Punto + huevos + Punto + esenciavainilla + Punto +'Piña' ;
         Ingredientes.appendChild(tag); 
