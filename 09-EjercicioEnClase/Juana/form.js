...
const myFunction = () => {
    ...
    if (Edad >=50) {
        document.getElementById("simayorsi").disabled = false;
        document.getElementById("simayorno").disabled = false;
        document.getElementById("simenorsi").disabled = true;
        document.getElementById("simenorno").disabled = true;

    }
    else if (Edad < 50) {
        document.getElementById("simenorsi").disabled = false;
        document.getElementById("simenorno").disabled = false;
        document.getElementById("simayorsi").disabled = true;
        document.getElementById("simayorno").disabled = true;
