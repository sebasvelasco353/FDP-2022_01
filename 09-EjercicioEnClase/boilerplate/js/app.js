...
* que pasar para que ocurra lo que necesito, y sasi tambien mantengo las cosas divididas, recuerden la importancia del orden y las funciones bien definidas.
*
...
const grupoSanguineo = ['A+', 'B+', 'O+', 'AB+', 'A-', 'B-', 'O-', 'AB-'];
 ...
 var edad;
     ...
     if (edad > 50) {
        console.log('si sirve pls');
     }
 /* no pude hacer el js :C tiste tiste*/ 