...
edad = document.getElementsByClassName("edad").value;
let msj = "";

if(=== ""){
  msj =  "Nesecitamos tu edad para arrojar resultados"
}

else if (edad < 50) {
    msj = "¿Se ha realizado pruebas de Azucar en los ultimos 3 meses?"
}

else if (edad >= 50) {
    msj = "Se ha realizado o no pruebas de colesterol y triglicéridos en los ultimos 6 meses"
}
