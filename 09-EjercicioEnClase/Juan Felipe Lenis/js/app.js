...
const elentoSelect = document.getElementById("fnationality");
...
function (registroDatos = () => {
    ...
    var Apellido = document.getElementById("flastname").value;
    var Edad = document.getElementById("fage").value;
    var Estatura = document.getElementById("fheight").value;

    console.log(NombreApellido, Edad, Estatura)
})