...
const handleClick = (e) => { 
        const obj = {
            ...
            Fumador: document.getElementById("Fumar").checked,
        ...
        alert('Correcto, ya esta listo')
    }

const masDatos = (f) => {
        if (document.getElementById("Edad").value >= 50) {
            document.getElementById("preguntaColesterol").style.display="block";
            document.getElementById("preguntaAzucar").style.display="none";
        } else {
            document.getElementById("preguntaAzucar").style.display="block";
            document.getElementById("preguntaColesterol").style.display="none";

        }
    }

    const botonRenovar = (g) => {  
        location.reload(); 
      }
