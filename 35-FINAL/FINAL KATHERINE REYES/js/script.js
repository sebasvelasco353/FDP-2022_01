...
const TIMEOUT_SIGUIENTE_PIEZA_MILISEGUNDOS = 100; 
// Cuántos milisegundos tiene el jugador para mover la pieza una vez que choca hacia abajo
const MILISEGUNDOS_AVANCE_PIEZA = 300;
const MILISEGUNDOS_ANIMACION_COLOR_DESAPARICION_FILA = 500; 
// Cuánto dura la animación de colorear los puntos. Recuerda que durante este tiempo, no se avanzará ni se dejará jugar al jugador
